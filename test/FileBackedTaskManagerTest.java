...
public class FileBackedTaskManagerTest {
    ...
    public void sameManagersFromLoadFile() throws IOException {
        ...
        Task task1 = new Task("Task1", "Description1", 1, StatusOfTask.NEW, LocalDateTime.now(), 10);
        Epic epic1 = new Epic("Epic1", "Description1",1, StatusOfTask.NEW, LocalDateTime.now(), 10);
        manager.add(task1);
        manager.add(epic1);
